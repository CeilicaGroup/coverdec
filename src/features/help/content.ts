...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    bullets: [
      "Vista semana: grid personas × días. Toggle Plan | Registros y escala Semana | Mes. Botón Imprevista → Nueva tarea imprevista (Admin/Jefe): proyecto obligatorio, observación para el empleado y motivo interno. Panel de imprevistas pendientes si las hay (editables antes de regenerar el planning). Vacío en plan: mensaje para volver a Resumen y Generar planning.",
