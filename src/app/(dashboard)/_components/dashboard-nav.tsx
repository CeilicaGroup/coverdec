    ...
    <div className={cn(compact ? "min-w-0" : "px-5 py-5 border-b")}>
      ...
      {activeNave ? (
        <div className="mt-1 flex items-center gap-1 text-[10px] text-muted-foreground">
          ...
          {!compact ? <span className="truncate">{activeNave.nombre}</span> : null}
        </div>
      ) : null}
